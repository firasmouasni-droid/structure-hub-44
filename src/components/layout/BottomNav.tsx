...
const navItems = [
  ...
  { label: "Coach", icon: Bot, path: "/coach" },
];
...
export const BottomNav = () => {
  ...
  return (
    <nav className="fixed bottom-0 left-0 right-0 z-50 lg:hidden">
      <div className="bg-white/90 backdrop-blur-xl border-t border-border/40 px-2 pb-[env(safe-area-inset-bottom)]">
                ...
                <div className="relative">
                  {isActive && (
                    <motion.div
                      ...
                      className="absolute -inset-2 rounded-2xl gradient-primary opacity-15"
                  ...
                  {badge && (
                    <span className="absolute -top-1.5 -right-2.5 w-4 h-4 rounded-full bg-destructive text-[9px] font-bold text-white flex items-center justify-center">
                      {badge}
                    </span>
                  )}
                </div>
