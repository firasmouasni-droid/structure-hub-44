                ...
                <HoverCard className="card-soft p-4 cursor-pointer" onClick={() => handleStatusChange(task.id, task.status)}>
                  <div className="flex items-center gap-4">
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <p className="text-[11px] text-muted-foreground">{task.domain || ''}{task.domain ? ' · ' : ''}{task.estimated_duration ? `${task.estimated_duration} min` : '-'} · {task.due_date || 'Pas de date'}</p>
                    </div>
                    ...
                    <div className="w-12 h-1.5 bg-muted rounded-pill overflow-hidden shrink-0 hidden sm:block">
