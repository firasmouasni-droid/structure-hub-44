        ...
        <div className="p-6 lg:p-8 max-w-5xl mx-auto space-y-6">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-muted-foreground">{goals.length} objectifs définis</p>
            </div>
          </div>
            ...
            {!isLoading && filtered.length === 0 && (
              <StaggerItem className="col-span-2">
                <div className="card-soft p-10 text-center">
                  ...
                  <p className="text-sm text-muted-foreground mt-1">Définis des objectifs pour suivre ta progression</p>
                </div>
              </StaggerItem>
            )}
            {filtered.map(g => {
                    ...
                    <div className="flex items-center gap-4">
                      ...
                      <div className="flex-1">
                        <div className="flex justify-between text-xs mb-1.5">
                          ...
                          <span className="font-bold text-foreground">{g.current_value} / {g.target_value || '?'}</span>
                        </div>
                        ...
                        {g.end_date && <p className="text-[11px] text-muted-foreground mt-1.5">Échéance : {g.end_date}</p>}
                      </div>
                    </div>
                  </HoverCard>
                </StaggerItem>
